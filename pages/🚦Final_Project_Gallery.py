...
with tab2:
    ...
    st.markdown("""
    + Group 1 Digital Classroom (Streamlit app): [Click to Enter](https://s25g01final.streamlit.app/)
...
with tab3:
    ...
    st.markdown("""
    + Group 2 Digital Classroom (Streamlit app): [Click to Enter](https://g02final.streamlit.app/)
